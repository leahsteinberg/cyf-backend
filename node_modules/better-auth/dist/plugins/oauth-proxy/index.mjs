...
import { c as createAuthMiddleware, a as createAuthEndpoint } from '../../shared/better-auth.ejRQe6H4.mjs';
    ...
    endpoints: {
      oAuthProxy: createAuthEndpoint(
        "/oauth-proxy-callback",
        {
          method: "GET",
          query: z.object({
            callbackURL: z.string().describe("The URL to redirect to after the proxy"),
