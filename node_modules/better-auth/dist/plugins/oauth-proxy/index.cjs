      ...
      oAuthProxy: session.createAuthEndpoint(
        "/oauth-proxy-callback",
        {
          ...
          query: z__namespace.object({
            callbackURL: z__namespace.string().describe("The URL to redirect to after the proxy"),
            cookies: z__namespace.string().describe("The cookies to set after the proxy")
          }),
