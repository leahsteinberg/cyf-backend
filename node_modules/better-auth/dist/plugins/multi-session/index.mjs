...
import { c as createAuthMiddleware, a as createAuthEndpoint, s as sessionMiddleware } from '../../shared/better-auth.ejRQe6H4.mjs';
    ...
    endpoints: {
      ...
      setActiveSession: createAuthEndpoint(
        "/multi-session/set-active",
        {
          method: "POST",
          body: z.object({
            sessionToken: z.string().describe("The session token to set as active")
          }),
          requireHeaders: true,
