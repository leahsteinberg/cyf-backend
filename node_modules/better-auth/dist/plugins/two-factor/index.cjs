...
const z = require('zod');
const session = require('../../shared/better-auth.C3Kf5JnA.cjs');
const betterCall = require('better-call');
require('../../shared/better-auth.CWOdECKJ.cjs');
    ...
    endpoints: {
      ...
      verifyBackupCode: session.createAuthEndpoint(
        "/two-factor/verify-backup-code",
        {
          ...
          body: z__namespace.object({
            code: z__namespace.string().describe(`A backup code to verify. Eg: "123456"`),
            /**
             * Disable setting the session cookie
             */
            disableSession: z__namespace.boolean().describe("If true, the session cookie will not be set.").optional(),
            /**
             * if true, the device will be trusted
             * for 30 days. It'll be refreshed on
             * every sign in request within this time.
             */
            trustDevice: z__namespace.boolean().describe("If true, the device will be trusted for 30 days. It").optional()
          }),
          metadata: {
            openapi: {
      ...
      generateBackupCodes: session.createAuthEndpoint(
        "/two-factor/generate-backup-codes",
        {
          method: "POST",
          body: z__namespace.object({
            password: z__namespace.string().describe("The users password.")
          }),
      ...
      viewBackupCodes: session.createAuthEndpoint(
        "/two-factor/view-backup-codes",
        {
          method: "GET",
          body: z__namespace.object({
            userId: z__namespace.coerce.string().describe(`The user ID to view all backup codes. Eg: "user-id"`)
          }),
          metadata: {
            SERVER_ONLY: true
          }
...
const otp2fa = (options) => {
  ...
  const send2FaOTP = session.createAuthEndpoint(
    "/two-factor/send-otp",
    {
      ...
      body: z__namespace.object({
         ...
         * every sign in request within this time.
         */
        trustDevice: z__namespace.boolean().optional().describe("If true, the device will be trusted for 30 days. It")
      }).optional(),
      metadata: {
        openapi: {
  ...
  const verifyOTP = session.createAuthEndpoint(
    "/two-factor/verify-otp",
    {
      method: "POST",
      body: z__namespace.object({
        code: z__namespace.string().describe("The otp code to verify. Eg: "),
        /**
         * if true, the device will be trusted
         * for 30 days. It'll be refreshed on
         * every sign in request within this time.
...
const totp2fa = (options) => {
  ...
  const generateTOTP = session.createAuthEndpoint(
    "/totp/generate",
    {
      method: "POST",
      body: z__namespace.object({
        secret: z__namespace.string().describe("The secret to generate the TOTP code")
      }),
      metadata: {
        openapi: {
  ...
  const getTOTPURI = session.createAuthEndpoint(
    "/two-factor/get-totp-uri",
    {
      ...
      use: [session.sessionMiddleware],
      body: z__namespace.object({
        password: z__namespace.string().describe("User password")
      }),
      metadata: {
        openapi: {
    ...
    endpoints: {
      ...
      enableTwoFactor: session.createAuthEndpoint(
        "/two-factor/enable",
        {
          ...
          body: z__namespace.object({
            password: z__namespace.string().describe("User password"),
            issuer: z__namespace.string().describe("Custom issuer for the TOTP URI").optional()
          }),
          use: [session.sessionMiddleware],
          metadata: {
            openapi: {
