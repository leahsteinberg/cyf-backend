...
import { g as getSessionFromCtx, a as createAuthEndpoint, s as sessionMiddleware, B as BASE_ERROR_CODES, c as createAuthMiddleware } from '../../shared/better-auth.ejRQe6H4.mjs';
import { APIError } from 'better-call';
import '../../shared/better-auth.CT_zTzdl.mjs';
    ...
    endpoints: {
      ...
      verifyBackupCode: createAuthEndpoint(
        "/two-factor/verify-backup-code",
        {
          ...
          body: z.object({
             ...
             */
            disableSession: z.boolean().describe("If true, the session cookie will not be set.").optional(),
            /**
             * if true, the device will be trusted
             * for 30 days. It'll be refreshed on
             * every sign in request within this time.
             */
            trustDevice: z.boolean().describe("If true, the device will be trusted for 30 days. It").optional()
          }),
          metadata: {
            openapi: {
      ...
      viewBackupCodes: createAuthEndpoint(
        "/two-factor/view-backup-codes",
        {
          method: "GET",
          body: z.object({
            userId: z.coerce.string().describe(`The user ID to view all backup codes. Eg: "user-id"`)
          }),
          metadata: {
            SERVER_ONLY: true
          }
  ...
  const send2FaOTP = createAuthEndpoint(
    "/two-factor/send-otp",
    {
      ...
      body: z.object({
         ...
         * every sign in request within this time.
         */
        trustDevice: z.boolean().optional().describe("If true, the device will be trusted for 30 days. It")
      }).optional(),
      metadata: {
        openapi: {
