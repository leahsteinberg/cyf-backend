    ...
    endpoints: {
      signInUsername: session.createAuthEndpoint(
        "/sign-in/username",
        {
          ...
          body: z__namespace.object({
            username: z__namespace.string().describe("The username of the user"),
            password: z__namespace.string().describe("The password of the user"),
            rememberMe: z__namespace.boolean().describe("Remember the user session").optional(),
      ...
      isUsernameAvailable: session.createAuthEndpoint(
        "/is-username-available",
        {
          method: "POST",
          body: z__namespace.object({
            username: z__namespace.string().describe("The username to check")
          })
        },
        async (ctx) => {
