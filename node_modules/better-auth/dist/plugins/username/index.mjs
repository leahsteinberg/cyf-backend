...
import { c as createAuthMiddleware, a as createAuthEndpoint, B as BASE_ERROR_CODES } from '../../shared/better-auth.ejRQe6H4.mjs';
...
import { k as createEmailVerificationToken } from '../../shared/better-auth.CT_zTzdl.mjs';
      ...
      signInUsername: createAuthEndpoint(
        "/sign-in/username",
        {
          ...
          body: z.object({
            ...
            rememberMe: z.boolean().describe("Remember the user session").optional(),
