...
const getSessionQuerySchema = z__namespace.optional(
  z__namespace.object({
     ...
     */
    disableCookieCache: z__namespace.boolean().describe("Disable cookie cache and fetch session from database").or(z__namespace.string().transform((v) => v === "true")).optional(),
    disableRefresh: z__namespace.boolean().describe(
