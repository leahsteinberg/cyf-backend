...
const socialProviders_index = require('../../shared/better-auth.CWOdECKJ.cjs');
      ...
      signInMagicLink: session.createAuthEndpoint(
        "/sign-in/magic-link",
        {
          ...
          body: z__namespace.object({
            email: z__namespace.string().describe("Email address to send the magic link").email(),
            name: z__namespace.string().describe(
              "User display name. Only used if the user is registering for the first time. Eg: "
            ).optional(),
            callbackURL: z__namespace.string().describe("URL to redirect after magic link verification").optional(),
            ...
            errorCallbackURL: z__namespace.string().describe("URL to redirect after error.").optional()
          }),
          metadata: {
            openapi: {
      ...
      magicLinkVerify: session.createAuthEndpoint(
        "/magic-link/verify",
        {
          ...
          query: z__namespace.object({
            token: z__namespace.string().describe("Verification token"),
            callbackURL: z__namespace.string().describe(
