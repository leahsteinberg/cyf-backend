...
import { a as createAuthEndpoint, B as BASE_ERROR_CODES } from '../../shared/better-auth.ejRQe6H4.mjs';
...
import { o as originCheck } from '../../shared/better-auth.CT_zTzdl.mjs';
    ...
    endpoints: {
      ...
      signInMagicLink: createAuthEndpoint(
        "/sign-in/magic-link",
        {
          ...
          requireHeaders: true,
          body: z.object({
            email: z.string().describe("Email address to send the magic link").email(),
            name: z.string().describe(
              "User display name. Only used if the user is registering for the first time. Eg: "
            ).optional(),
            callbackURL: z.string().describe("URL to redirect after magic link verification").optional(),
            ...
            errorCallbackURL: z.string().describe("URL to redirect after error.").optional()
          }),
          metadata: {
            openapi: {
