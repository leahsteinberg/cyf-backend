...
const getSessionQuerySchema = z__namespace.optional(
  z__namespace.object({
     ...
     */
    disableCookieCache: z__namespace.coerce.boolean().describe("Disable cookie cache and fetch session from database").optional(),
    disableRefresh: z__namespace.coerce.boolean().describe(
...
const revokeSession = createAuthEndpoint(
  "/revoke-session",
  {
    ...
    body: z__namespace.object({
      token: z__namespace.string().describe("The token to revoke")
    }),
