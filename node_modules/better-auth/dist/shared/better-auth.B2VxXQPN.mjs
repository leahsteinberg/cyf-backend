...
import { a as createAuthEndpoint, g as getSessionFromCtx, s as sessionMiddleware, B as BASE_ERROR_CODES, j as requestOnlySessionMiddleware } from './better-auth.ejRQe6H4.mjs';
import './better-auth.CT_zTzdl.mjs';
...
import { o as orgMiddleware, a as orgSessionMiddleware, t as teamSchema } from './better-auth.CNeuX76b.mjs';
...
const createInvitation = (option) => {
  ...
  const baseSchema = z.object({
    ...
    organizationId: z.string().describe("The organization ID to invite the user to").optional(),
    resend: z.boolean().describe(
    ...
    teamId: z.union([
      ...
      z.array(z.string()).describe("The team IDs to invite the user to").optional()
    ])
  });
...
const listInvitations = (options) => createAuthEndpoint(
  "/organization/list-invitations",
  {
    ...
    use: [orgMiddleware, orgSessionMiddleware],
    query: z.object({
      organizationId: z.string().describe("The ID of the organization to list invitations for").optional()
    }).optional()
  },
  async (ctx) => {
    const session = await getSessionFromCtx(ctx);
...
const addMember = (option) => {
  ...
  const baseSchema = z.object({
    userId: z.coerce.string().describe(
      "The user Id which represents the user to be added as a member"
    ),
    role: z.union([z.string(), z.array(z.string())]).describe("The role(s) to assign to the new member"),
    organizationId: z.string().describe(
      "An optional organization ID to pass. If not provided, will default to the user"
    ).optional(),
    teamId: z.string().describe("An optional team ID to add the member to").optional()
  });
  return createAuthEndpoint(
...
const removeMember = (options) => createAuthEndpoint(
  "/organization/remove-member",
  {
    method: "POST",
    body: z.object({
      memberIdOrEmail: z.string().describe("The ID or email of the member to remove"),
      /**
...
const updateMemberRole = (option) => createAuthEndpoint(
  "/organization/update-member-role",
  {
    method: "POST",
    body: z.object({
      role: z.union([z.string(), z.array(z.string())]).describe(
...
const leaveOrganization = (options) => createAuthEndpoint(
  "/organization/leave",
  {
    method: "POST",
    body: z.object({
      organizationId: z.string().describe("The organization Id for the member to leave")
    }),
    requireHeaders: true,
...
const listMembers = (options) => createAuthEndpoint(
  "/organization/list-members",
  {
    method: "GET",
    query: z.object({
      limit: z.string().describe("The number of users to return").or(z.number()).optional(),
      offset: z.string().describe("The offset to start from").or(z.number()).optional(),
      sortBy: z.string().describe("The field to sort by").optional(),
      sortDirection: z.enum(["asc", "desc"]).describe("The direction to sort by").optional(),
      filterField: z.string().describe("The field to filter by").optional(),
      filterValue: z.string().describe("The value to filter by").or(z.number()).or(z.boolean()).optional(),
      filterOperator: z.enum(["eq", "ne", "lt", "lte", "gt", "gte", "contains"]).describe("The operator to use for the filter").optional(),
      organizationId: z.string().describe(
...
const createOrganization = (options) => {
  ...
  const baseSchema = z.object({
    ...
    metadata: z.record(z.string(), z.any()).describe("The metadata of the organization").optional(),
    keepCurrentActiveOrganization: z.boolean().describe(
    ...
    "/organization/update",
    {
      ...
      body: z.object({
        data: z.object({
          ...
          slug: z.string().describe("The slug of the organization").optional(),
          logo: z.string().describe("The logo of the organization").optional(),
          metadata: z.record(z.string(), z.any()).describe("The metadata of the organization").optional()
        }).partial(),
        organizationId: z.string().describe("The organization ID. Eg: ").optional()
      }),
      requireHeaders: true,
      use: [orgMiddleware],
      metadata: {
...
const getFullOrganization = (options) => createAuthEndpoint(
  "/organization/get-full-organization",
  {
    ...
    query: z.optional(
      z.object({
        organizationId: z.string().describe("The organization id to get").optional(),
        organizationSlug: z.string().describe("The organization slug to get").optional(),
        membersLimit: z.number().or(z.string().transform((val) => parseInt(val))).describe(
  ...
  return createAuthEndpoint(
    "/organization/set-active",
    {
      ...
      body: z.object({
        ...
        organizationSlug: z.string().describe(
...
const removeTeam = (options) => createAuthEndpoint(
  "/organization/remove-team",
  {
    method: "POST",
    body: z.object({
      teamId: z.string().describe(`The team ID of the team to remove. Eg: "team-id"`),
      organizationId: z.string().describe(
...
const updateTeam = (options) => {
  ...
  return createAuthEndpoint(
    "/organization/update-team",
    {
      method: "POST",
      body: z.object({
        teamId: z.string().describe(`The ID of the team to be updated. Eg: "team-id"`),
        data: z.object({
          ...teamSchema.shape,
          ...additionalFieldsSchema.shape
        }).partial()
...
const removeTeamMember = (options) => createAuthEndpoint(
  "/organization/remove-team-member",
  {
    method: "POST",
    body: z.object({
      teamId: z.string().describe("The team the user should be removed from."),
      userId: z.coerce.string().describe("The user which should be removed from the team.")
    }),
    metadata: {
      openapi: {
  ...
  return createAuthEndpoint(
    "/organization/create-role",
    {
      ...
      body: z.object({
        ...
        permission: z.record(z.string(), z.array(z.string())).describe("The permission to assign to the role"),
  ...
  return createAuthEndpoint(
    "/organization/update-role",
    {
      ...
      body: z.object({
        ...
        data: z.object({
          permission: z.record(z.string(), z.array(z.string())).optional().describe("The permission to update the role with"),
          roleName: z.string().optional().describe("The name of the role to update"),
          ...additionalFieldsSchema.shape
        })
      }).and(
        z.union([
