...
const sendVerificationEmail = session.createAuthEndpoint(
  "/send-verification-email",
  {
    ...
    body: z__namespace.object({
      email: z__namespace.string().email().describe("The email to send the verification email to"),
...
const changeEmail = session.createAuthEndpoint(
  "/change-email",
  {
    method: "POST",
    body: z__namespace.object({
      newEmail: z__namespace.string().email().describe("The new email address to set must be a valid email address"),
      callbackURL: z__namespace.string().describe("The URL to redirect to after email verification").optional()
    }),
    use: [session.sensitiveSessionMiddleware],
    metadata: {
