...
require('./better-auth.CWOdECKJ.cjs');
const session = require('./better-auth.C3Kf5JnA.cjs');
    ...
    endpoints: {
      ...
      registerOAuthApplication: session.createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: z__namespace.object({
            redirect_uris: z__namespace.array(z__namespace.string()).describe("A list of redirect URIs. Eg: ["),
            token_endpoint_auth_method: z__namespace.enum(["none", "client_secret_basic", "client_secret_post"]).describe(
            ...
            ).describe("The grant types supported by the application. Eg: [").default(["authorization_code"]).optional(),
            response_types: z__namespace.array(z__namespace.enum(["code", "token"])).describe(
              "The response types supported by the application. Eg: ["
            ).default(["code"]).optional(),
            client_name: z__namespace.string().describe("The name of the application. Eg: ").optional(),
            client_uri: z__namespace.string().describe("The URI of the application. Eg: ").optional(),
            logo_uri: z__namespace.string().describe("The URI of the application logo. Eg: ").optional(),
            scope: z__namespace.string().describe(
              "The scopes supported by the application. Separated by spaces. Eg: "
            ).optional(),
            contacts: z__namespace.array(z__namespace.string()).describe("The contact information for the application. Eg: [").optional(),
            tos_uri: z__namespace.string().describe("The URI of the application terms of service. Eg: ").optional(),
            policy_uri: z__namespace.string().describe("The URI of the application privacy policy. Eg: ").optional(),
            jwks_uri: z__namespace.string().describe("The URI of the application JWKS. Eg: ").optional(),
            jwks: z__namespace.record(z__namespace.any(), z__namespace.any()).describe(
              'The JWKS of the application. Eg: {"keys": [{"kty": "RSA", "alg": "RS256", "use": "sig", "n": "...", "e": "..."}]}'
            ).optional(),
            metadata: z__namespace.record(z__namespace.any(), z__namespace.any()).describe('The metadata of the application. Eg: {"key": "value"}').optional(),
            software_id: z__namespace.string().describe("The software ID of the application. Eg: ").optional(),
            software_version: z__namespace.string().describe("The software version of the application. Eg: ").optional(),
            software_statement: z__namespace.string().describe("The software statement of the application.").optional()
          }),
          metadata: {
            openapi: {
