...
import { d as deleteSessionCookie, s as setSessionCookie, b as setCookieCache } from './better-auth.pyHheoY8.mjs';
...
const getSessionQuerySchema = z.optional(
  z.object({
     ...
     */
    disableCookieCache: z.coerce.boolean().describe("Disable cookie cache and fetch session from database").optional(),
    disableRefresh: z.coerce.boolean().describe(
