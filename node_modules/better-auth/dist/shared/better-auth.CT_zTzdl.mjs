...
import { c as createAuthMiddleware, a as createAuthEndpoint, g as getSessionFromCtx, B as BASE_ERROR_CODES, i as sensitiveSessionMiddleware, s as sessionMiddleware, f as freshSessionMiddleware } from './better-auth.ejRQe6H4.mjs';
...
const sendVerificationEmail = createAuthEndpoint(
  "/send-verification-email",
  {
    ...
    body: z.object({
      ...
      callbackURL: z.string().describe("The URL to use for email verification callback").optional()
    }),
    metadata: {
      openapi: {
...
const verifyEmail = createAuthEndpoint(
  "/verify-email",
  {
    ...
    query: z.object({
      ...
      callbackURL: z.string().describe("The URL to redirect to after email verification").optional()
    }),
...
const signInSocial = createAuthEndpoint(
  "/sign-in/social",
  {
    ...
    body: z.object({
       ...
       * has signed in.
       */
      callbackURL: z.string().describe("Callback URL to redirect to after the user has signed in").optional(),
      /**
       ...
       * the current url.
       */
      errorCallbackURL: z.string().describe("Callback URL to redirect to if an error happens").optional(),
      /**
       ...
       */
      disableRedirect: z.boolean().describe(
      ...
      idToken: z.optional(
        z.object({
           ...
           */
          nonce: z.string().describe("Nonce used to generate the token").optional(),
          /**
           * Access token from the provider
           */
          accessToken: z.string().describe("Access token from the provider").optional(),
          /**
           * Refresh token from the provider
           */
          refreshToken: z.string().describe("Refresh token from the provider").optional(),
          /**
       ...
       */
      loginHint: z.string().describe("The login hint to use for the authorization code request").optional()
    }),
    metadata: {
      openapi: {
...
const signInEmail = createAuthEndpoint(
  "/sign-in/email",
  {
    ...
    body: z.object({
       ...
       */
      callbackURL: z.string().describe("Callback URL to use as a redirect for email verification").optional(),
      /**
       * If this is false, the session will not be remembered
       * @default true
       */
      rememberMe: z.boolean().describe(
...
const requestPasswordReset = createAuthEndpoint(
  "/request-password-reset",
  {
    ...
    body: z.object({
       ...
       * token=VALID_TOKEN
       */
      redirectTo: z.string().describe("The URL to redirect the user to reset their password").optional()
    }),
    metadata: {
      openapi: {
...
const changePassword = createAuthEndpoint(
  "/change-password",
  {
    ...
    body: z.object({
       ...
       */
      revokeOtherSessions: z.boolean().describe("Must be a boolean value").optional()
    }),
...
const deleteUser = createAuthEndpoint(
  "/delete-user",
  {
    ...
    body: z.object({
       ...
       */
      callbackURL: z.string().describe("The callback URL to redirect to after the user is deleted").optional(),
      /**
       * The password of the user. If the password isn't provided, session freshness
       * will be checked.
       */
      password: z.string().describe("The password of the user is required to delete the user").optional(),
      /**
       * The token to delete the user. If the token is provided, the user will be deleted
       */
      token: z.string().describe("The token to delete the user is required").optional()
    }),
    metadata: {
      openapi: {
...
const deleteUserCallback = createAuthEndpoint(
  "/delete-user/callback",
  {
    ...
    query: z.object({
      ...
      callbackURL: z.string().describe("The URL to redirect to after deletion").optional()
    }),
    use: [originCheck((ctx) => ctx.query.callbackURL)],
    metadata: {
      openapi: {
...
const changeEmail = createAuthEndpoint(
  "/change-email",
  {
    method: "POST",
    body: z.object({
      newEmail: z.string().email().describe("The new email address to set must be a valid email address"),
      callbackURL: z.string().describe("The URL to redirect to after email verification").optional()
    }),
    use: [sensitiveSessionMiddleware],
    metadata: {
...
const linkSocialAccount = createAuthEndpoint(
  "/link-social",
  {
    ...
    body: z.object({
       ...
       */
      callbackURL: z.string().describe("The URL to redirect to after the user has signed in").optional(),
      /**
       * OAuth2 provider to use
       */
      provider: SocialProviderListEnum,
       ...
       */
      scopes: z.array(z.string()).describe("Additional scopes to request from the provider").optional(),
      /**
...
const getAccessToken = createAuthEndpoint(
  "/get-access-token",
  {
    ...
    body: z.object({
      ...
      accountId: z.string().describe("The account ID associated with the refresh token").optional(),
      userId: z.string().describe("The user ID associated with the account").optional()
    }),
    metadata: {
      openapi: {
