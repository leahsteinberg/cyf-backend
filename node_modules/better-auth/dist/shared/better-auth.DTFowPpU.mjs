...
import { g as getSessionFromCtx, a as createAuthEndpoint, c as createAuthMiddleware, s as sessionMiddleware } from './better-auth.ejRQe6H4.mjs';
    ...
    endpoints: {
      ...
      registerOAuthApplication: createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: z.object({
            redirect_uris: z.array(z.string()).describe("A list of redirect URIs. Eg: ["),
            token_endpoint_auth_method: z.enum(["none", "client_secret_basic", "client_secret_post"]).describe(
            ...
            response_types: z.array(z.enum(["code", "token"])).describe(
              "The response types supported by the application. Eg: ["
            ).default(["code"]).optional(),
            client_name: z.string().describe("The name of the application. Eg: ").optional(),
            client_uri: z.string().describe("The URI of the application. Eg: ").optional(),
            logo_uri: z.string().describe("The URI of the application logo. Eg: ").optional(),
            scope: z.string().describe(
              "The scopes supported by the application. Separated by spaces. Eg: "
            ).optional(),
            contacts: z.array(z.string()).describe("The contact information for the application. Eg: [").optional(),
            tos_uri: z.string().describe("The URI of the application terms of service. Eg: ").optional(),
            policy_uri: z.string().describe("The URI of the application privacy policy. Eg: ").optional(),
            jwks_uri: z.string().describe("The URI of the application JWKS. Eg: ").optional(),
            jwks: z.record(z.any(), z.any()).describe(
              'The JWKS of the application. Eg: {"keys": [{"kty": "RSA", "alg": "RS256", "use": "sig", "n": "...", "e": "..."}]}'
            ).optional(),
            metadata: z.record(z.any(), z.any()).describe('The metadata of the application. Eg: {"key": "value"}').optional(),
            software_id: z.string().describe("The software ID of the application. Eg: ").optional(),
            software_version: z.string().describe("The software version of the application. Eg: ").optional(),
            software_statement: z.string().describe("The software statement of the application.").optional()
          }),
          metadata: {
            openapi: {
