 ...
 */
export async function createDraftMeeting(params) {
    const { userFromId, scheduledEnd, scheduledFor, backupScheduledTimes, title, timeType, targetType, sourceType, intentLabel, targetUserIds, suggestionReason, minParticipants, maxParticipants } = params;
 ...
 */
export function validateDraftMeetingOwnership(meeting, userId) {
...
//# sourceMappingURL=draft-meeting.js.map