...
const isTransitionActorAllowed = (meeting, toState, actorId) => {
    const meetingActorRole = getMeetingActorRole({ meeting, actorId });
...
const isTimeValid = async (meeting, toState) => {
...
const allowedRolesForGoalState = {
...
const buildDomainEvents = ({ fromState, toState, meeting }) => {
};
const getMeetingActorRole = ({ meeting, actorId }) => {
...
//# sourceMappingURL=transition-meeting.js.map