import { meetingTypeToNew, newToMeetingType, ACCEPTED_MEETING_STATE, SEARCHING_MEETING_STATE, IMMEDIATE_TIME_TYPE, OPEN_TARGET_TYPE, DISMISSED_DRAFT_MEETING_STATE, UNCLAIMED_BROADCAST_STATE } from "../../types.js";
...
export const setMeetingAcceptors = async ({ meetingId, userId }) => {
...
export const setMeetingOpen = async ({ meetingId }) => {
    const updatedMeeting = prisma.meeting.update({
        where: {
            id: meetingId,
        },
...
export const setMeetingDismissed = async ({ meetingId }) => {
    const updatedMeeting = prisma.meeting.update({
        where: {
            id: meetingId,
        },
...
export const unclaimBroadcastMeeting = async ({ meetingId }) => {
...
export const deleteMeetingAndOffers = async ({ meetingId }) => {
...
export const updateMeetingState = async (meeting, toState, acceptedUserId, scheduledFor, scheduledEnd) => {
...
//# sourceMappingURL=meeting-update.js.map