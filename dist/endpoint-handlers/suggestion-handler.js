...
export const handleDismissSuggestion = async (req, res) => {
...
export const handleCreateSuggestion = async (req, res) => {
    ...
    meetingType, 
    // NEW API (preferred)
    timeType, targetType, sourceType, intentLabel, targetUserIds } = req.body;
    try {
...
export const handleCreateSampleSuggestion = async (req, res) => {
    // const { userId } = req.body;
...
//# sourceMappingURL=suggestion-handler.js.map