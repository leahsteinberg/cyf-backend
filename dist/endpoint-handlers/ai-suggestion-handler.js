...
export const handleGenerateSuggestions = async (req, res) => {
    ...
    try {
        ...
        const meetings = await Promise.all(suggestions.map(s => createMeetingFromSuggestion(userId, s)));
        res.json({
...
//# sourceMappingURL=ai-suggestion-handler.js.map